...
public class HypothesisTest {
	...
	public static void main(String args[]){
		...
		System.out.println(getConfidence(l));
		Double conf = getConfidence(l);
		Double avg = mean(l);
		Double h0 = 201.0;
		if(h0 > (avg-conf) && h0 < (avg+conf)){
			
			System.out.println("Yes accept !!");
			
		}else{
			System.out.println("No dont accept !!");
		}
		
	}
	
	
	public static Double getConfidence(Double[] l){
